          ...
          <form className='space-y-4'>
            <div className='flex flex-col'>
              ...
              <input
                ...
                disabled={!editMode}
                className={`border ${editMode ? "border-gray-500" : "border-gray-300"
                  } rounded p-2 focus:outline-none focus:ring ${editMode ? "focus:ring-orange-600" : ""
                  }`}
              />
            </div>
            <div className='flex flex-col'>
            ...
            <div className='flex justify-end space-x-4 mt-4'>
              ...
              <button
                type='button'
                className={`py-2 px-4 rounded ${hasChanges
