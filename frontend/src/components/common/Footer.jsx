    ...
    <footer className='bg-black text-white py-10'>
      <div className='max-w-7xl mx-auto px-6 lg:px-8'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          ...
          <div>
            ...
            <p className='text-gray-400 text-sm'>
              FitPro is a comprehensive fitness platform built
              to deliver a seamless experience for both fitness
              enthusiasts and trainers. Whether you're looking
              to stay fit, discover new classes, or grow your
              training business.
            </p>
        ...
        <div className='mt-8 border-t border-gray-800 pt-4 text-center text-gray-500 text-sm'>
          Copyright ©2025 All rights reserved | This website is made
          by&nbsp;&nbsp;
          <Link
            to='/about'
