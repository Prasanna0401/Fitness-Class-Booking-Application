...
const createPayment = async (req, res) => {
  ...
  const create_payment_json = {
    ...
    redirect_urls: {
      return_url: `https://fitproapp.vercel.app/paymentsuccess?classId=${classId}`,
      cancel_url: `https://fitproapp.vercel.app/paymentcancel?classId=${classId}`,
    },
  };
...
export default { paymentAndBookingSuccess, createPayment };